...
async function testLoadLibrary() {
    try {
        ...
        if (typeof globalThis.OPL3.OPL3 === 'undefined') {
...
async function testCreateChip() {
    try {
        log('TEST 2: Creating OPL3 chip instance...');
        const OPL3Class = globalThis.OPL3.OPL3;
        chip = new OPL3Class();
...
async function testInitializeChip() {
    try {
        ...
        function writeReg(register, value) {
...
// === TEST 5: Trigger Note ===
async function testTriggerNote() {
    try {
...
// === TEST 7: Verify Audio ===
async function testVerifyAudio() {
    try {
